...
use "Data\Paper2_Differential_Completion_Data.dta", clear

keep finprovid finclinid public private completed oneshot timespent percent_recqe dual round theta_pv1 theta_pv2 theta_pv3 theta_pv4 theta_pv5 ///
	case2 case3 case1 case numafter correct_treat helpful_treat wrong_treat correct_only antibiotic totalmeds ///
	ssp1-ssp15 sspname theta_mle _m isdual
	
save "Data\DualDifferentialCompletion.dta", replace
